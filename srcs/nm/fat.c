...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/10 09:29:08 by abassibe          #+#    #+#             */
/*   Updated: 2020/07/10 09:30:32 by abassibe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/ft_nm.h"

static int	fat_init(t_nm *data, struct fat_arch *fat, uint32_t *offset,
		cpu_type_t *cpu_type)
{
...
static int	parse_fat(t_nm *data, struct fat_arch *fat)
{
	...
	if (fat_init(data, fat, &offset, &cpu_type) == -1)
		return (-1);
	cpu_subtype = data->is_endianess ? bswap_int32(fat->cpusubtype) :
		fat->cpusubtype;
...
static int	fat_section(t_nm *data, struct fat_arch *fat,
