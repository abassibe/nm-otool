...
/*   Updated: 2020/07/10 09:26:37 by abassibe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char							*ft_strdup_overflow(t_nm *data, char *src,
		char end_char, int *failed);

int								macho_file(t_nm *data);
int								macho_segment(t_nm *data);
t_list							*create_mysym(t_nm *data, char *strtab,
		void *sym);

void							print_symbols(t_nm *data);
void							ft_hexdump(t_nm *data, void *start,
		int64_t size, int64_t start_address);
